...
load(file = "models/cover/forbs/all/coda/coda_rep.Rdata") # coda.rep
...
length(which(dat$forbs ==0))/nrow(dat)
# ~0.2% observations of 0 native grass cover
...
jpeg(filename = "models/cover/forbs/all/plots/fig1_betas2.jpg", 
     width = 6, 
     height = 3, 
     units = "in",
     res = 600)
...
jpeg(filename = "models/cover/forbs/all/plots/fig1_betas.jpg", 
     width = 6, 
     height = 4, 
     units = "in",
     res = 600)
...
jpeg(filename = "models/cover/forbs/all/plots/fig2_betas.jpg", 
     width = 8, 
     height = 6, 
     units = "in",
     res = 600)
